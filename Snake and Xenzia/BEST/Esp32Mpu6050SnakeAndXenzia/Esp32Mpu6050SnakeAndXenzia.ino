...
#define NUM_LEDS    256
#define LED_PIN     16 //GPIO 16 of ESP 32
int rows = 16;
int columns = 16;
CRGB leds[NUM_LEDS];
...
//Joystick
#define PAUSE_PIN 20 //GPIO for push button
// const int xPin = 36; //GPIO 36
// const int yPin = 39; //GPIO 39
...
int getCurrentDirection(){
  ...
  int mapX = map(a.acceleration.x, -10, 10, -512, 512);
  int mapY = map(a.acceleration.y, -10, 10, -512, 512);
